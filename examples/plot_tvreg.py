r"""
Total Variation (TV) Regularization on GPU
==========================================
...
noise = torch.normal(0., 1., size=x.shape).to(dev)
y = Iop * (x + noise)
...
xinv = xinv = pylops_gpu.NormalEquationsInversion(
        Op=Iop,
        Regs=[D2op],
...
xinv, niter, _, _, _, _ = pylops_gpu.SplitBregman(Iop, [Dop], y, niter_out,
